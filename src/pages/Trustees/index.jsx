                ...
                <div className="modal">
                    ...
                    <div className="modal__content">
                        <div className="modal__title">
                            <TbTie size={50} color={config[2].active ? "#fff" : "#000"} />
                            <h2>Cadastro Síndicos</h2>
                        </div>
                        <div className="modal__form">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="modal__row grid-3-2">
                                    <div className="modal__field">
                                ...
                                <div className="modal__row grid-1-5">
                                    <div className="modal__field">
                                        <label htmlFor="professionals">
                                            Profissional
                                        </label>
                                        <input
                                            type="text"
                                            ...
                                            value={professionals}
                                            onChange={(e) =>
                                                setProfessionals(e.target.value)
                                            }
                                            placeholder="Sim"
                                        />
                                    </div>
